...
class Fundingsources_RequestController extends MyIndo_Controller_Action
{
	...
	{
		$this->_model = new fundingsources_Model_FundingSources();
		$this->_modelView = new fundingsources_Model_FundingSourcesView();
		$this->_unique = 'Funding Source';
